...
exp_dir_path = top_dir+'/exp_dir/fish_localise'
...
model.load_weights('/home/stevenwudi/Documents/Python_Project/Kaggle_The_Nature_Conversancy_Fisheries_Monitoring/Kaggle_Nature_conservancy/exp_dir/fish_localise/training/fine_tune_all_conv_resnet50.h5')
# fine-tune the model
model.fit_generator(
    train_generator,
...
model.save(os.path.join("/home/stevenwudi/Documents/Python_Project/Kaggle_The_Nature_Conversancy_Fisheries_Monitoring/Kaggle_Nature_conservancy/exp_dir/fish_localise",
                                'training', 'fish_detection_resnet50.h5'))
