...
train_data_dir = os.path.join(exp_dir_path, 'train_day_no_enhancement')
validation_data_dir = os.path.join(exp_dir_path, 'valid_day_no_enhancement')
...
def further_fine_tune():
    ...
    for lr in lr_list:
        ...
        model.save(os.path.join(exp_dir_path, 'day_fish_classifier.h5'))
    print('Done')
    # Epoch
    # 49 / 50
    # 3680 / 3680[ == == == == == == == == == == == == == == ==] - 146
    # s - loss: 0.0019 - acc: 0.9995 - categorical_crossentropy: 0.0019 - val_loss: 0.2132 - val_acc: 0.9375 - val_categorical_crossentropy: 0.2132
    # Epoch
    # 50 / 50
    # 3680 / 3680[ == == == == == == == == == == == == == == ==] - 146
    # s - loss: 0.0015 - acc: 1.0000 - categorical_crossentropy: 0.0015 - val_loss: 0.0021 - val_acc: 1.0000 - val_categorical_crossentropy: 0.0021
