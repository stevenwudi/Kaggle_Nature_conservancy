...
train_data_dir = os.path.join(exp_dir_path, 'train_night_no_enhancement')
validation_data_dir = os.path.join(exp_dir_path, 'valid_night_no_enhancement')

nb_train_samples = 1049
nb_validation_samples = 118
nb_epoch = 20
n_out = 8
...
def further_fine_tune():
    ...
    for lr in lr_list:
        ...
        model.save(os.path.join(exp_dir_path, 'night_fish_classifier.h5'))
    print('Done')
    # Epoch
    # Epoch
    # 49 / 50
    # 1049 / 1049[ == == == == == == == == == == == == == == ==] - 43
    # s - loss: 0.0011 - acc: 1.0000 - categorical_crossentropy: 0.0011 - val_loss: 0.0621 - val_acc: 0.9915 - val_categorical_crossentropy: 0.0621
    # Epoch
    # 50 / 50
    # 1049 / 1049[ == == == == == == == == == == == == == == ==] - 43
    # s - loss: 0.0018 - acc: 1.0000 - categorical_crossentropy: 0.0018 - val_loss: 0.1233 - val_acc: 0.9831 - val_categorical_crossentropy: 0.1233
